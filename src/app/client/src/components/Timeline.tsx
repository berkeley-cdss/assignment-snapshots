...
function Timeline() {
  ...
  const handleClick0 = () => {
    setVariant0((prevVariant) => (prevVariant === 'contained' ? 'outlined' : 'contained'));
  ...
  const buttons = [
    <Button variant={variant0} onClick={handleClick0} key="one">04/09/25 09:00 AM PST <ErrorIcon sx={{marginLeft: '10px'}} /></Button>,
    <Button variant={variant1} onClick={handleClick1} key="two">04/09/25 10:00 AM PST <LoopIcon sx={{marginLeft: '10px'}} /></Button>,
    <Button variant={variant2} onClick={handleClick2} key="three">04/09/25 11:00 AM PST <DoneIcon sx={{marginLeft: '10px'}} /></Button>,
  ];

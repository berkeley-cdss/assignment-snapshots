...
function getBreadcrumbName(path: string): string | undefined {
    ...
    if (parts.length >= 2 && parts[0] === 'courses' && courses[parts[1]]) {
        ...
        if (parts.length >= 4 && parts[2] === 'assignments' && assignments[parts[3]]) {
...
function BreadcrumbNav() {
    ...
    return (
        <div style={{ padding: '1rem', borderBottom: '1px solid lightGrey', backgroundColor: 'white' }}>

...
4. To get started with some toy development data **if you are on the IRB protocol** (internal contributors only):
    1. Replace the `data` directory with the contents of this zip file (unzip it first): [data.zip](https://drive.google.com/file/d/1Td5_YZ2SGv2kzDtmfpJ4y-sFXRvSwZX4/view?usp=drive_link)
